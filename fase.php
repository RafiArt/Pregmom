  ...
  <nav class="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="home.php"><span
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mx-auto"></ul><a class="btn btn-primary shadow" role="button" href="logout.php"
          style="border-radius: 12px;background: #49516f;font-family: Poppins, sans-serif;padding-top: 11.6px;border: 1px none #ff2391;width: 91.5px;padding-left: 20px;">Keluar</a>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12" style="margin-bottom: 10px;margin-top: 10px;">
          <div style="width: 686px;">
            <p style="font-size: 44.44px;font-weight: bold;color: #49516f;font-family: Poppins, sans-serif;">Fase mana
              yang sedang mommy alami saat ini...</p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div style="margin-bottom: 18px;"><a class="btn btn-primary shadow" role="button" href="fase_program_kehamilan.php"
              style="border-radius: 55.56px;background: #ff2391;border-width: 1px;border-color: #ff2391;font-family: Poppins, sans-serif;font-size: 33.33px;width: 450px;text-align: left;padding-left: 45px;">Program
              Kehamilan</a></div>
          <div style="margin-bottom: 18px;"><a class="btn btn-primary shadow" role="button" href="fase_sedang_hamil.php"
              style="border-radius: 55.56px;background: #ff2391;border-width: 1px;border-color: #ff2391;font-family: Poppins, sans-serif;font-size: 33.33px;width: 450px;text-align: left;padding-left: 45px;">Sedang
              Hamil</a></div>
          <div style="margin-bottom: 18px;"><a class="btn btn-primary shadow" role="button" href="fase_pasca_melahirkan.php"
              style="border-radius: 55.56px;background: #ff2391;border-width: 1px;border-color: #ff2391;font-family: Poppins, sans-serif;font-size: 33.33px;width: 450px;text-align: left;padding-left: 45px;">Pasca
              Melahirkan</a></div>
        </div>
      </div>
      ...
      <div class="row justify-content-center" style="margin-top: 20px;">
        ...
        <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="width: 517px;">
          ...
          <ul class="list-unstyled">
            <li><a href="mailto:pregmom01@gmail.com"
                style="font-size: 18.89px;color: rgb(245,245,245);font-family: Poppins, sans-serif;"><img
            ...
            <li><a style="font-size: 18.89px;color: rgb(245,245,245);font-family: Poppins, sans-serif;"
                href="https://wa.link/sn2m16"><img src="/assets/img/whatsapp.png?h=0b00d958a774444ce5d38613d48cd9c0"
