  ...
  <nav class="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="/index.php"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><img src="/assets/img/1664268155719.png?h=8d712739119881ce6b0b113c1a533e45" width="114" height="229" style="width: 34px;height: 34px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="navbar-nav mx-auto"></ul><a class="btn btn-primary shadow" role="button" href="/login.php" style="border-radius: 12px;width: 90px;padding-left: 18px;background: #ff2391;border-width: 1px;border-color: #ff2391;font-family: Poppins, sans-serif;">Masuk</a>
      </div>
    </div>
        ...
        <div class="card mb-5" style="border-width: 0px;">
          <div class="card-body d-flex flex-column align-items-center">
            <form class="text-center" method="post">
              <div class="mb-3">
                <div class="d-flex flex-row align-items-center mb-4"><span class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="border-color: rgb(3,95,187);background: #ff2391;border-top-left-radius: 17px;width: 54.4375px;height: 54.4375px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" class="d-xxl-flex align-items-xxl-center" style="width: 34.44px;height: 34.44px;color: rgb(255,255,255);">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M3.00977 5.83789C3.00977 5.28561 3.45748 4.83789 4.00977 4.83789H20C20.5523 4.83789 21 5.28561 21 5.83789V17.1621C21 18.2667 20.1046 19.1621 19 19.1621H5C3.89543 19.1621 3 18.2667 3 17.1621V6.16211C3 6.11449 3.00333 6.06765 3.00977 6.0218V5.83789ZM5 8.06165V17.1621H19V8.06199L14.1215 12.9405C12.9499 14.1121 11.0504 14.1121 9.87885 12.9405L5 8.06165ZM6.57232 6.80554H17.428L12.7073 11.5263C12.3168 11.9168 11.6836 11.9168 11.2931 11.5263L6.57232 6.80554Z" fill="currentColor"></path>
                    </svg></span><input class="form-control" type="email" name="email" placeholder="Email" style="border-radius: 0px;height: 54.4375px;width: 312.23px;border-color: rgb(255,35,145);font-family: Poppins, sans-serif;" value="<?php echo $email; ?>" required>

                </div>
              </div>
              <div class="mb-3">
                <div class="d-flex flex-row align-items-center mb-4"><span class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="border-color: rgb(3,95,187);background: #ff2391;border-top-left-radius: 0px;width: 54.4375px;height: 54.4375px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="width: 34.44px;height: 34.44px;color: rgb(255,255,255);">
                      <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z">
                      </path>
                    </svg></span>
                  <input class="form-control" type="text" name="username" style="height: 54.4375px;border-radius: 0px;border-width: 1px;border-color: #ff2391;border-top-color: rgb(45,;border-right-color: 45,;border-bottom-color: 45);border-left-color: 45,;width: 312.23px;" placeholder="Nama Lengkap" value="<?php echo $username; ?>" required>

                </div>
              </div>
              <div class="mb-3" style="font-family: Poppins, sans-serif;">
                <div class="d-flex flex-row align-items-center mb-4" style="font-family: Poppins, sans-serif;"><span class="d-xxl-flex justify-content-xxl-center align-items-xxl-center" style="background: #ff2391;font-family: Poppins, sans-serif;width: 54.4375px;height: 54.4375px;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none" style="width: 34.44px;height: 34.44px;color: rgb(255,255,255);">
                  ...
                  <input class="form-control" type="password" name="password" placeholder="Password" style="border-color: #ff2391;border-radius: 0px;width: 312.23px;height: 54.4375px;border-bottom-right-radius: 17px;font-family: Poppins, sans-serif;" value="<?php echo $_POST['password']; ?>" required>

                </div>
              </div>
              <div class="mb-3">
                <button class="btn btn-primary d-block w-100" type="submit" name="submit" style="font-size: 33.33px;border-radius: 55.56px;background: #ff2391;font-weight: bold;font-family: Poppins, sans-serif;border-width: 0px;">DAFTAR</button>
              </div>
      ...
      <div class="row justify-content-center" style="margin-top: 20px;">
        ...
        <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item" style="width: 517px;">
          ...
          <ul class="list-unstyled">
            <li><a href="#" style="font-size: 18.89px;color: rgb(245,245,245);font-family: Poppins, sans-serif;"><img src="/assets/img/mail.png?h=d916c4a35a849b9ae264268096cdff2f" style="width: 35px;height: 35px;margin-right: 10px;">cs@pregmom.id</a></li>
            <li><a href="#" style="font-size: 18.89px;color: rgb(245,245,245);font-family: Poppins, sans-serif;"><img src="/assets/img/whatsapp.png?h=0b00d958a774444ce5d38613d48cd9c0" style="width: 35px;height: 35px;margin-right: 10px;">0853 3566 9905</a></li>
          </ul>
        </div><!-- End: Services -->
        <!-- Start: Services -->
