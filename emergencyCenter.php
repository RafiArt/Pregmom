...
<body>
    ...
    <main class="page contact-us-page">
        ...
        <div class="container mx-auto" style="margin: 36px;margin-bottom: 50px;">
            <div>
                <h1 style="font-family: Poppins, sans-serif;font-size: 44.48x;margin-top: 30px;color: #49516f;font-weight: bold;">Emergency Center</h1>
            </div>
            <div class="row">
        ...
        <div class="container" style="width: 64%;">
            <h1 style="font-family: Poppins, sans-serif;font-size: 33.33px;font-weight: bold;margin-top: 30px;color: rgba(0,0,0,0.6);margin-bottom: 20px;margin-left: 22px;">Rekomendasi Rumah Sakit Terdekat</h1>
        </div><!-- End: 1 Row 2 Columns -->
        <!-- Start: 1 Row 1 Column -->
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="margin-bottom: 32px;">
                    <div class="d-xxl-flex align-items-xxl-center mx-auto" style="height: 162px;padding-left: 17px;border-radius: 27px;background: #D9D9D9;width: 973px;">
                        <div class="d-xxl-flex align-items-xxl-center"><img width="166" height="126" src="/assets/img/image_6.png?h=abc838136e67b1459c6237d6f6550f5c" style="border-radius: 22px;">
                            <div style="margin-left: 35px;">
                                <h1 style="font-weight: bold;font-family: Poppins, sans-serif;font-size: 28px;color: #ff2391;">RSIA Lombok Dua Dua Surabaya</h1><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0315022044"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                    ...
                                    </svg>Ambulance Call</a><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0315022044"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                                    </svg>Emergency Call</a><a class="btn btn-primary" role="button" style="background: #FF66C4;border-style: none;color: rgb(255,255,255);font-size: 20px;height: 62.27px;margin-right: 24px;width: 130.1px;padding-top: 14px;" href="emerCent_LDDS.php">Rute</a>
                            </div>
                        </div>
                        <div></div>
                    </div>
                ...
                <div class="col-md-12" style="margin-bottom: 32px;">
                    <div class="d-xxl-flex align-items-xxl-center mx-auto" style="height: 162px;padding-left: 17px;border-radius: 27px;background: #D9D9D9;width: 973px;">
                        <div class="d-xxl-flex align-items-xxl-center"><img width="166" height="126" src="/assets/img/RSIA%20Kendangsari%20Jadwal%20Praktek%20Dokter.jpg?h=0fcbe3b9a43547e441548193c5f5913d" style="border-radius: 22px;">
                            <div style="margin-left: 35px;">
                                <h1 style="font-weight: bold;font-family: Poppins, sans-serif;font-size: 28px;color: #ff2391;">RS Ibu dan Anak Kendangsari<br></h1><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0318437200"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                                    </svg>Ambulance Call</a><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0318437200"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                                    </svg>Emergency Call</a><a class="btn btn-primary" role="button" style="background: #FF66C4;border-style: none;color: rgb(255,255,255);font-size: 20px;height: 62.27px;margin-right: 24px;width: 130.1px;padding-top: 14px;" href="emerCent_IDAK.php">Rute</a>
                            </div>
                        </div>
                        <div></div>
                    </div>
                ...
                <div class="col-md-12" style="margin-bottom: 32px;">
                    <div class="d-xxl-flex align-items-xxl-center mx-auto" style="height: 162px;padding-left: 17px;border-radius: 27px;background: #D9D9D9;width: 973px;">
                        <div class="d-xxl-flex align-items-xxl-center"><img width="166" height="126" src="/assets/img/unnamed.jpg?h=15fabadfd23d2db12166378d2539fd92" style="border-radius: 22px;">
                            <div style="margin-left: 35px;">
                                <h1 style="font-weight: bold;font-family: Poppins, sans-serif;font-size: 28px;color: #ff2391;">RSIA Cempaka Putih<br></h1><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0318282350"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                                    </svg>Ambulance Call</a><a class="btn btn-primary" role="button" style="background: #C4C4C4;border-style: none;color: rgb(0,0,0);font-size: 20px;width: 275.77px;height: 62.27px;margin-right: 24px;padding-top: 14px;" href="tel:0318282350"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-telephone" style="font-size: 33px;margin-right: 20px;">
                                        <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"></path>
                                    </svg>Emergency Call</a><a class="btn btn-primary" role="button" style="background: #FF66C4;border-style: none;color: rgb(255,255,255);font-size: 20px;height: 62.27px;margin-right: 24px;width: 130.1px;padding-top: 14px;" href="emerCent_CP.php">Rute</a>
                            </div>
                        </div>
                        <div></div>
                    </div>
